      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-neutral-100 leading-tight">
            ...
            <span className="block text-mboa-gold">by Leo Dassie</span>
          </h1>
          ...
          >
            ...
            <br />
            <span className="mboa-gold">
              Master of cocktails, curator of vibes. Afro Pop bartender bringing
              liquid artistry to life.
            </span>
          </motion.p>
        ...
        >
          ...
          <div className="relative">
            <Link className="block" href="/drinks">
              <div
              ...
              >
                <div className="grid grid-cols-5 h-14 items-center">
                  ...
                  <div className="col-span-1 h-full flex items-center justify-center bg-gradient-to-r from-yellow-500/80 to-yellow-700/80 relative">
                    ...
                    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-px h-8 bg-black/20" />
                  </div>
          ...
          <div className="relative">
            <Link className="block" href="/contact">
              <div
                className="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full overflow-hidden hover:shadow-2xl hover:shadow-yellow-400/25 transition-all duration-300 transform hover:scale-105 cursor-pointer  hover:bg-white"
                role="button"
                tabIndex={0}
              >
                <div className="grid grid-cols-5 h-14 items-center">
                  ...
                  <div className="col-span-1 h-full flex items-center justify-center bg-white/10 group-hover:bg-white/20 relative">
                    <span className="text-[27px] group-hover:scale-110 transition-transform duration-300">
                      📞
                    </span>
                    {/* Vertical divider line */}
                    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-px h-8 bg-white/30" />
                  </div>
