            ...
            <NavbarItem key={item.href}>
              <NextLink
                className={clsx(
                  ...
                  "text-white data-[active=true]:text-white data-[active=true]:font-medium hover:text-white transition-colors duration-300 !text-white",
                )}
                color="foreground"
                href={item.href}
              >
      ...
      >
        <NavbarItem className="hidden sm:flex gap-3">
          <Link 
            ...
            className="text-white hover:text-white transition-colors duration-300 !text-white"
          >
