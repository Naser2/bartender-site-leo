      ...
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-3" href="/">
            <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-mboa-gold/30">
              <Image
                src="/MBOA_LOGO.jpg"
                alt="MBOA-NYC Logo"
                width={40}
              ...
              />
                          ...
                          <div>
                <p className="font-bold text-inherit text-xl mboa-gold">MBOA-NYC</p>
                <p className="text-xs text-neutral-200">by Leo Dassie</p>
              </div>
          </NextLink>
        </NavbarBrand>
            ...
            <NavbarItem key={item.href}>
              <NextLink
                className={clsx(
                  ...
                  "data-[active=true]:text-mboa-gold data-[active=true]:font-medium hover:text-mboa-gold transition-colors duration-300",
                )}
                color="foreground"
                href={item.href}
              >
      ...
      >
        <NavbarItem className="hidden sm:flex gap-3">
          <Link 
            ...
            className="text-default-500 hover:text-mboa-gold transition-colors duration-300"
          >
          ...
          {siteConfig.navMenuItems.map((item, index) => (
            <NavbarMenuItem key={`${item}-${index}`}>
              <NextLink
                ...
                className={clsx(
                  "w-full block py-3 px-2 text-lg transition-colors duration-300",
                  index === 2
                    ? "text-primary hover:text-primary/80"
                    : index === siteConfig.navMenuItems.length - 1
                      ? "text-warning hover:text-warning/80"
                      : "text-foreground hover:text-mboa-gold"
                )}
              >
                {item.label}
              </NextLink>
